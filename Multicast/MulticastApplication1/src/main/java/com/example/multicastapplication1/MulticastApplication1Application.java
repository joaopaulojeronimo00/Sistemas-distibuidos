package com.example.multicastapplication1;
...
public class MulticastApplication1Application {

    public static void main(String[] args) {
        SpringApplication.run(MulticastApplication1Application.class, args);
    }
