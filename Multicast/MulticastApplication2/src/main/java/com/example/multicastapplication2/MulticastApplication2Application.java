package com.example.multicastapplication2;
...
public class MulticastApplication2Application {

    public static void main(String[] args) {
        SpringApplication.run(MulticastApplication2Application.class, args);
    }
